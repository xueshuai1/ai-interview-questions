...
**知识库示例：**
- `content/knowledge/LLM/002_LLM（大语言模型）位置编码详解.mdx`
- `content/knowledge/LLM/003_RAG（检索增强生成）检索增强生成.mdx`
- `content/knowledge/LLM/005_LLM（大语言模型）应用开发实战.mdx`
- `content/knowledge/LLM/006_Prompt（提示）Engineering（工程）实战指南.mdx` ⭐ 标准示例
