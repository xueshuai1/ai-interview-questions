// Append 15 new news entries to news.ts
...
// Remove the trailing "  }\n] as NewsItem[];" 
content = content.replace(/\s*\]\s*as\s+NewsItem\[\]\s*;?\s*$/, '');
...
const entries = `  {
    ...
    content: \`Anthropic 首届 Code w/ Claude 2026 开发者大会正式开幕。

- Claude Dreaming：Agent 在任务间隙自动"做梦"，反刍记忆自我进化
- 多 Agent 协作：多个 Agent 分工处理复杂任务
- 自动评分官：AI 自动评估输出质量，形成闭环
- 任务完成率暴涨 6 倍
- Simon Willison 现场 Live Blog 全程记录

**来源：** Anthropic + Simon Willison + 36 氪
...
**链接：** https://techcrunch.com/2026/05/06/deepseek-could-hit-45b-valuation-from-its-first-investment-round/\`,
  ...
  },
  {
    ...
    summary: "xAI 作为独立公司被正式解散，并入 SpaceX 后更名为 SpaceXAI，马斯克宣布 xAI 将成为 SpaceX 的 AI 产品线。",
    content: \`马斯克的 AI 版图发生重大变化。

- xAI 作为独立公司被正式解散，并入 SpaceX
- 新名称为 SpaceXAI
- 此前 xAI 已与 Anthropic 达成算力合作伙伴关系
- xAI 正在转向算力租赁的"AI 卖水人"模式
...
**链接：** https://www.theverge.com/ai-artificial-intelligence/925469/xai-is-becoming-spacexai\`,
  ...
  },
  {
    ...
    summary: "OpenAI 联创 Greg Brockman 出庭作证，详细讲述马斯克离开 OpenAI 的过程，包括不祥短信和 300 亿美元股份争议。",
    content: \`一场牵动全球 AI 界的世纪庭审正在展开。

- Greg Brockman 出庭作证讲述马斯克离开 OpenAI 的完整经过
- 争议焦点：马斯克是否曾要求 300 亿美元回购股份
- Helen Toner 称"制造 AI 模型更像炼金术而非化学"
- Microsoft 律师反复强调"微软不在场"成庭审最大笑点
...
- OpenAI 联合五大巨头发布 MRC（Multipath Reliable Connection）协议
...
**链接：** https://openai.com/index/mrc-supercomputer-networking/\`,
  ...
  },
  {
    ...
    summary: "AI 管理的斯德哥尔摩咖啡店出现大量荒诞采购，Simon Willison 批评此类实验不应在无人监督下影响真实世界。",
    content: \`一个看似有趣的 AI 实验引发了严肃的伦理讨论。

- Andon Labs 在斯德哥尔摩经营一家由 AI（Mona）管理的咖啡店
- AI 订购 120 个鸡蛋但店里没有炉灶；订购 22.5 公斤罐装番茄用于鲜三明治
- 员工建立"耻辱墙"展示 AI 的奇葩订单
- AI 自行向警方申请户外座位许可，附带从未见过的街道图纸
- Simon Willison：不应在无人监督的情况下让 AI 影响真实世界
...
**链接：** https://simonwillison.net/2026/May/5/our-ai-started-a-cafe-in-stockholm/\`,
  ...
  },
  {
    ...
    summary: "Anthropic 推出面向金融服务的 AI Agent 套装，覆盖合规、风控、投研等核心场景，对万得、同花顺构成挑战。",
...
**链接：** https://www.anthropic.com/news/finance-agents\`,
  ...
  },
  {
    ...
    summary: "SAP 以 11.6 亿美元收购一家成立仅 18 个月的德国 AI 实验室，同时宣布采用 NemoClaw AI 框架。",
    content: \`传统软件巨头正在用真金白银拥抱 AI。

- SAP 以 11.6 亿美元收购一家成立仅 18 个月的德国 AI 实验室
...
**链接：** https://techcrunch.com/2026/05/05/sap-bets-1-16b-on-18-month-old-german-ai-lab-and-says-yes-to-nemoclaw/\`,
  ...
  },
  {
    ...
    summary: "在 AI 芯片需求持续爆发的推动下，三星电子市值首次突破 1 万亿美元。",
    content: \`AI 热潮正在重塑全球半导体产业格局。

- 三星电子市值首次突破 1 万亿美元
- 主要受 AI 芯片和 HBM 高带宽内存需求爆发推动
- AI 算力需求正从云端向边缘扩展
...
**链接：** https://techcrunch.com/2026/05/06/ai-boom-pushes-samsung-to-1t/\`,
  ...
  },
  {
    ...
    content: \`Apple Intelligence 推进速度引发用户不满。

- Apple 同意支付 2.5 亿美元和解 Siri AI 功能延迟诉讼
- Apple 计划在 iOS 27 中允许用户自选第三方 AI 模型
...
**链接：** https://techcrunch.com/2026/05/06/apple-to-pay-250m-to-settle-lawsuit-over-siris-delayed-ai-features/\`,
  ...
  },
  {
    ...
    summary: "月之暗面（Moonshot AI）即将完成 20 亿美元新一轮融资，估值约 1400 亿元人民币。",
    content: \`中国大模型融资潮继续升温。

- 月之暗面将完成 20 亿美元新融资，估值约 1400 亿元人民币
- 与 DeepSeek 450 亿美元融资形成呼应
...
**链接：** https://finance.sina.com.cn/tech/shenji/2026-05-07/doc-inhwzrtk7789989.shtml\`,
  ...
  },
  {
    ...
    summary: "腾讯混元 Hy3 preview 上线仅两周，Token 调用量增长 10 倍，显示国内企业对腾讯大模型需求旺盛。",
...
**链接：** https://finance.sina.com.cn/tech/shenji/2026-05-07/doc-inhwzrtp8521239.shtml\`,
  ...
  },
  {
    ...
    summary: "受 AI 算力需求持续爆发驱动，AMD 市值暴涨 6800 亿元，英伟达斥资 218 亿投资光纤，半导体产业链全线受益。",
    content: \`AI 芯片赛道正迎来历史性行情。

- AMD 市值暴涨 6800 亿元人民币
- 英伟达投资 218 亿元押注光纤基础设施
- 四巨头联合发布 MRC 超算网络协议
...
- 同期 arXiv 还发布了 DTap 红队平台（279 页，148 张图）
...
**链接：** https://arxiv.org/abs/2605.04785\`,
  ...
  },
  {
    ...
    summary: "AI 语音合成公司 ElevenLabs 宣布引入 BlackRock 等重量级投资者，显示 AI 语音技术正吸引主流资本关注。",
...
console.log('✅ 已添加 15 条新闻 (news-994 ~ news-1008)');
