#!/usr/bin/env node
// Rewrite all guide articles: replace broken ASCII diagrams with proper short code blocks
import { readFileSync, writeFileSync } from 'fs';

const DIR = 'src/data/articles';

function writeArticle(id, title, category, tags, summary, contentSections) {
  const sectionsStr = contentSections.map(s => {
    const fields = [];
    fields.push(`        {`);
    ...
    if (s.table) {
      fields.push(`            table: { headers: ${JSON.stringify(s.table.headers)}, rows: ${JSON.stringify(s.table.rows)} },`);
    }
...
// ----- Prompt Engineering -----
guides.push(writeArticle('prompt-guide', 'Prompt Engineering 学习导览', 'llm',
...
// ----- LLM 应用 -----
guides.push(writeArticle('llm-app-guide', 'LLM 应用开发学习导览', 'llm',
...
// ----- AI Agent -----
guides.push(writeArticle('agent-guide', 'AI Agent 实战学习导览', 'agent',
...
// ----- AI 工程化 -----
guides.push(writeArticle('aieng-guide', 'AI 工程化实践学习导览', 'aieng',
...
// ----- 数学 + ML -----
guides.push(writeArticle('math-ml-guide', '入门基础学习导览：数学与机器学习', 'ml',
  ['数学', '机器学习', '学习导览', '入门'],
...
// ----- 深度学习 -----
guides.push(writeArticle('dl-guide', '深度学习核心技术学习导览', 'dl',
...
// ----- 强化学习 -----
guides.push(writeArticle('rl-guide', '强化学习学习导览', 'rl',
...
// ----- NLP -----
guides.push(writeArticle('nlp-guide', '自然语言处理学习导览', 'nlp',
  ['NLP', '学习导览', '词嵌入', 'BERT'],
...
// ----- CV -----
guides.push(writeArticle('cv-guide', '计算机视觉学习导览', 'cv',
  ['CV', '学习导览', 'CNN', '目标检测'],
...
// ----- 多模态 -----
guides.push(writeArticle('mm-guide', '多模态学习学习导览', 'mm',
  ['多模态', '学习导览', 'CLIP', '视觉语言'],
...
// ----- 生成式 AI -----
guides.push(writeArticle('genai-guide', '生成式 AI 学习导览', 'genai',
...
// ----- AI 安全 -----
guides.push(writeArticle('security-guide', 'AI 安全与隐私学习导览', 'ethics',
...
guides.forEach(g => {
  ...
  writeFileSync(`${DIR}/${id}.ts`, g, 'utf-8');
  console.log(`✅ ${id}.ts`);
});

console.log(`\n总计重写 ${guides.length} 篇导览文章`);
