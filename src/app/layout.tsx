...
export const metadata: Metadata = {
  ...
  description: "AI Master 是专业的人工智能学习与实践平台。提供 250+ 篇 AI 知识库文章、60+ 篇深度技术博客、180+ AI 工具推荐、每日 AI 前沿动态。从入门到精通，探索大语言模型、AI Agent、RAG、机器学习等热门技术。",
  ...
  openGraph: {
    ...
    description: "专业的人工智能学习与实践平台。250+ 知识库文章，60+ 深度博客，180+ AI 工具推荐，每日 AI 前沿动态。",
  },
  twitter: {
