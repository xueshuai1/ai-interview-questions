    ...
    >
      ...
      <div className="flex gap-4 mt-8 pt-6 border-t border-gray-200">
        <Link
          ...
          className="px-6 py-3 bg-blue-600 text-white rounded-xl hover:bg-blue-700 transition-all font-medium no-underline"
        >
          浏览该分类其他文章
        </Link>
        <Link
          href="/knowledge"
          className="px-6 py-3 bg-white text-blue-600 border border-blue-600 rounded-xl hover:bg-blue-50 transition-all font-medium no-underline"
        >
          返回知识库
        </Link>
        <Link
