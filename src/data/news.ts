...
**链接：** https://techcrunch.com/2026/05/05/elevenlabs-lists-blackrock-jamie-foxx-and-eva-longoria-as-new-investors/`,
  ...
  },,
  {
    ...
    content: "Anthropic 首届 Code w/ Claude 2026 开发者大会开幕。Claude Dreaming 让 Agent 在任务间隙自动做梦，反刍记忆自我进化。多 Agent 协作和自动评分官形成闭环，任务完成率暴涨 6 倍。Simon Willison 现场全程 Live Blog 记录。这标志着 Claude 正从单次对话助手进化为持续工作的智能体。",
    date: "2026-05-07 20:00",
  ...
  },
  {
    ...
    tag: "行业",
    title: "DeepSeek 首轮融资曝光：国家队领投，估值直奔 450 亿美元",
    summary: "国家大基金被曝与 DeepSeek 洽谈首轮融资，估值可能达 450 亿美元，成为中国 AI 最大单笔融资之一。",
    content: "中国 AI 赛道迎来历史性融资事件。国家集成电路产业投资基金（大基金）被曝与 DeepSeek 洽谈首轮融资，估值可能达 450 亿美元（约 3000 亿元人民币）。这是中国 AI 领域迄今最大规模单笔融资之一。DeepSeek 凭借开源模型和极致性价比策略在全球 AI 竞赛中异军突起。",
    date: "2026-05-07 20:00",
  ...
  },
  {
    ...
    content: "马斯克的 AI 版图发生重大变化。xAI 作为独立公司被正式解散，并入 SpaceX 后更名为 SpaceXAI。此前 xAI 已与 Anthropic 达成算力合作，同时正转向算力租赁模式。估值约 2300 亿美元的 xAI 在 5 月 6 日终结其独立身份。",
    date: "2026-05-07 20:00",
  ...
  },
  {
    ...
    content: "一场牵动全球 AI 界的世纪庭审正在展开。Greg Brockman 出庭作证讲述马斯克离开 OpenAI 的完整经过。争议焦点是马斯克是否曾要求 OpenAI 以 300 亿美元回购其股份。Helen Toner 称制造 AI 模型更像炼金术而非化学。Microsoft 律师反复强调微软不在场，成庭审笑点。",
    date: "2026-05-07 20:00",
    source: "TechCrunch + The Verge",
    sourceUrl: "https://techcrunch.com/2026/05/06/how-elon-musk-left-openai-according-to-greg-brockman/",
    href: "/news/news-997",
  },
  {
    ...
    content: "AI 基础设施领域迎来重要突破。OpenAI 联合五大芯片和科技巨头发布 MRC（多路径可靠连接）协议，显著提升大规模 GPU 训练集群的网络性能和弹性。一级核心交换机可直接重启而不影响模型训练。完整规范已通过开放计算项目（OCP）公开发布。",
    date: "2026-05-07 20:00",
    source: "OpenAI + The Verge + 智东西",
    sourceUrl: "https://openai.com/index/mrc-supercomputer-networking/",
    href: "/news/news-998",
  },
  {
    ...
    content: "一个看似有趣的 AI 实验引发严肃的伦理讨论。Andon Labs 在斯德哥尔摩经营一家由 AI 管理的咖啡店。AI 曾订购 120 个鸡蛋但店里没有炉灶，订购了 22.5 公斤罐装番茄用于新鲜三明治。AI 自行向警方申请户外座位许可，附带自己生成的从未见过的街道图纸。Simon Willison 指出：不应在无人监督的情况下让 AI 影响真实世界。",
    date: "2026-05-07 20:00",
    source: "Simon Willison's Weblog",
    sourceUrl: "https://simonwillison.net/2026/May/5/our-ai-started-a-cafe-in-stockholm/",
    href: "/news/news-999",
  ...
  },
  {
    ...
    tag: "政策",
    title: "Apple 同意支付 2.5 亿美元和解 Siri AI 功能延迟诉讼",
    summary: "Apple 同意支付 2.5 亿美元，和解因 Siri AI 功能更新严重延迟而引发的集体诉讼。",
  ...
  },
  {
    ...
    content: "中国大模型融资潮继续升温。月之暗面将完成 20 亿美元新融资，估值约 1400 亿元人民币。与 DeepSeek 450 亿美元融资形成呼应，中国 AI 估值体系正在重塑。国产大模型正在加速融资节奏。同时老股暗流涌动：谁在从中国大模型公司悄悄套现？",
    date: "2026-05-07 20:00",
    source: "新浪科技 + 36氪",
    sourceUrl: "https://finance.sina.com.cn/tech/shenji/2026-05-07/doc-inhwzrtk7789989.shtml",
    href: "/news/news-1004",
  ...
  },
  {
    ...
    title: "arXiv 前沿：AgentTrust 提出 AI Agent 工具使用运行时安全评估框架",
    summary: "最新 arXiv 论文提出 AgentTrust 框架，可在 AI Agent 使用外部工具时进行实时安全评估和拦截。",
    content: "随着 AI Agent 越来越多地调用外部工具，安全性成为核心挑战。AgentTrust 框架针对 AI Agent 工具使用场景，提供运行时安全评估和拦截能力。31 页论文，含 2 张图和 15 张表。同一期 arXiv 还发布了 DTap 红队平台（279 页，148 张图）。",
    date: "2026-05-07 20:00",
    source: "arXiv",
    sourceUrl: "https://arxiv.org/abs/2605.04785",
    href: "/news/news-1007",
