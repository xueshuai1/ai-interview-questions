...
- 日本希望通过「物理 AI」在下一代机器人竞争中占据一席之地`,
  ...
  },
  {
    ...
    tag: "AI 工具",
    tagColor: "bg-green-500/10 text-green-300",
    title: "Google Chrome 推出 AI 驱动「技能」功能 — 浏览器内自动化操作新范式",
    summary: "WIRED 报道 Google Chrome 推出全新 AI 驱动「Skills」功能，允许用户在浏览器内创建和使用 AI 驱动的自动化技能。用户可通过自然语言描述任务，Chrome AI 自动完成表单填写、数据提取、页面操作等重复性工作。",
    content: `## Chrome AI 技能：浏览器自动化的新入口

2026 年 4 月，Google Chrome 推出 AI 驱动的「Skills」功能。

**功能特点：**
- **自然语言任务描述**：用日常语言告诉 Chrome 你想做什么
- **自动化操作**：自动完成表单填写、数据提取、页面导航等重复任务
- **技能市场**：用户可以分享和下载他人创建的 AI 技能
- **浏览器原生集成**：无需安装扩展，直接在 Chrome 中使用
...
**行业影响：**
- Chrome 作为全球最大浏览器（65%+市场份额），AI 技能功能可能重塑浏览器使用方式
- 与 AI Agent 趋势一致：从「人操作浏览器」到「AI 操作浏览器」
- 可能冲击浏览器扩展生态，部分扩展功能被 AI 技能替代`,
    date: "2026-04-15 10:30",
    source: "WIRED",
