...
export const news: NewsItem[] = [
  {
    ...
    content: `![news-036](/images/news/funding.jpg)
...
- 这预示着 AI 行业的"军备竞赛"将进一步升级`,
  ...
  },
  {
    ...
    content: `![news-035](/images/news/security.jpg)
...
- 华尔街对此做出紧急响应，财政部长和美联储主席召集银行 CEO 讨论潜在风险`,
  ...
  },
  {
    ...
    content: `![news-034](/images/news/meta-layoffs.jpg)
...
- 广告业务因 AI 优化实现了显著增长`,
  ...
  },
  {
    ...
    content: `![news-033](/images/news/microsoft-ai.jpg)
...
- 微软此举意味着所有科技巨头都在追求 AI 自主可控`,
  ...
  },
  {
    ...
    content: `![news-032](/images/news/regulation.jpg)
...
- 参议员 Bernie Sanders 和众议员 AOC 提出了 AI 数据中心暂停法案`,
  ...
  },
  {
    ...
    content: `![news-030](/images/news/mit-research.jpg)
...
随着 AI 模型规模不断扩大，CompreSSM 等技术解决了现代 AI 开发中最大的挑战之一：在性能与成本和效率之间取得平衡。通过在学习本身减少计算开销，这种方法有望降低先进 AI 能力的获取门槛。`,
  ...
  },
  {
    ...
    content: `![news-031](/images/news/policy.jpg)
...
- 美国框架代表了一种更宽松的、以市场驱动创新为中心的方法`,
  ...
  },
  {
    ...
    content: `![news-005](/images/news/nuclear-energy.jpg)
...
核能项目面临严格的监管审批流程和安全标准，科技巨头的涌入虽然带来了资金和关注度，但也需要应对复杂的环境审查和地方政府的许可程序。`,
  ...
  },
  {
    ...
    content: `![news-013](/images/news/eu-ai.jpg)
...
- 部分专家警告，过度的政治游说可能导致监管真空，使公众面临更大的 AI 安全风险`,
  ...
  },
  {
    ...
    content: `![news-012](/images/news/llm-benchmark.jpg)
...
- 2026 年的基准评测格局比以往更加碎片化，也更实用`,
  ...
  },
  {
    ...
    content: `![news-011](/images/news/wall-street.jpg)
...
- 预示着未来 AI 模型的发布可能需要经过更严格的多部门审查流程`,
  ...
  },
  {
    ...
    content: `![news-037](/images/news/venture-capital.jpg)
...
Tech Megacaps 计划投入超过 **3000 亿美元**用于 AI 基础设施建设，这还不包括风险投资市场的资金。`,
  ...
  },
  {
    ...
    content: `![news-038](/images/news/cyber-warning.jpg)
...
AI 发展需要 massive 算力，但算力的物理基础设施（数据中心）正在与当地社区利益产生直接冲突。这场博弈将深刻影响 AI 行业的未来布局。`,
  ...
  },
  {
    ...
    content: `![news-042](/images/news/coding.jpg)
...
"AI 改变了开发者选择编程语言的方式。当 AI 让某种技术的使用变得无缝时，开发者就会蜂拥而至。"——GitHub 开发者关系团队称之为"便利循环"效应。`,
  ...
  },
  {
    ...
    content: `![news-043](/images/news/github-copilot.jpg)
...
如果你担心代码隐私，可以前往 GitHub 设置页面关闭 "Allow GitHub to use Copilot interactions for AI model training" 选项。`,
  ...
  },
  {
    ...
    content: `![news-044](/images/news/models.jpg)
