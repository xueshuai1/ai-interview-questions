...
export const tools: Tool[] = [
  ...
  // ==================== 本轮新增 ====================
  {
    ...
    name: "Crawl4AI",
    category: "framework",
    description: "面向 AI Agent 的开源 Web 爬取框架，支持网页爬虫、Markdown 生成、JavaScript 执行和 LLM 结构化提取。为 Agent 提供可靠的 Web 数据获取能力",
  ...
  },
  {
    ...
    category: "llm",
    description: "Google DeepMind 发布的实体推理模型，专为机器人设计。支持空间推理（精准指向/计数）、多视角理解、仪表盘读取（与 Boston Dynamics Spot 合作）、任务成功检测。通过 Gemini API 和 Google AI Studio 开放",
  ...
  },
  {
    ...
    name: "MiniMax M2.7",
    category: "agent",
    description: "MiniMax 开源的自进化 Agent 模型，SWE-Pro 基准 56.22%、Terminal-Bench-2 57.0%。中国 Agent 模型竞争格局的重要参与者，配套 MMX-CLI 命令行工具提供多模态原生访问能力",
  ...
  },
  {
    ...
    name: "MMX-CLI",
    category: "cli",
    description: "MiniMax 命令行工具，为 AI Agent 提供图像、视频、语音、音乐、视觉、搜索的原生访问能力。适合 Agent 自主调用的多模态 CLI 接口",
    url: "https://github.com/MiniMax-AI",
