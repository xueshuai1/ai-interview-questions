...
export const tools: Tool[] = [
  ...
  },
  {
    ...
    name: "Kronos (金融基础模型)",
    category: "model",
    description: "金融市场语言基础模型，专注金融时间序列理解和预测，GitHub 17.4k⭐，单日增长 1.5k⭐，Python 开源，由 shiyu-coder 团队开发",
    url: "https://github.com/shiyu-coder/Kronos",
    tags: ["开源", "金融 AI", "时间序列", "基础模型", "GitHub Trending"],
    price: "开源",
    icon: "📈",
    updatedAt: "2026-04-14",
  },
  {
    id: "claude-mem",
    name: "claude-mem (Claude 记忆插件)",
    category: "developer",
    description: "Claude Code 自动记忆插件——自动捕获编码会话内容，用 AI 压缩存储，在后续会话中注入相关上下文，GitHub 54.3k⭐，单日增长 3.2k⭐，TypeScript 开源",
    url: "https://github.com/thedotmack/claude-mem",
    tags: ["开源", "Claude Code", "记忆管理", "上下文注入", "GitHub Trending"],
    price: "开源",
    icon: "🧠",
    updatedAt: "2026-04-14",
  },
