...
createdAt: "2023-02-08T22:28:03Z",
  ...
  },
  {
      ...
      category: "agent",
      description: "NousResearch 出品的可成长型 AI Agent 平台，106,487 stars，单周暴涨 30,630 stars（爆炸级），2026 年 GitHub 增长最快的 AI Agent 项目。号称可成长型 AI，支持持续学习和能力累积，通过经验积累和自我优化，Agent 能够在执行任务中不断提升效率和准确性",
...
createdAt: "2024-10-31T16:00:56Z",
  ...
  {
    id: "gpt-academic",
    name: "GPT Academic (binary-husky)",
    category: "llm",
...
createdAt: "2020-01-05T04:11:06Z",
  ...
  },
  {
      ...
      category: "plugin",
      description: "Claude Code 自动记忆插件（GitHub 64,675 星），自动捕获编码会话中的所有操作，用 AI 压缩后注入后续会话，解决上下文丢失问题，支持长期记忆和智能检索。单周增长 12,472 星，两周总计 64,675 星，是 2026 年增长最快的 Agent 记忆工具",
...
createdAt: "2026-01-14T17:48:09Z",
  ...
  {
      id: "dive-into-llms",
      name: "Dive into LLMs (Lordog)",
      category: "education",
      description: `《动手学大模型 Dive into LLMs》—— 最全面的中文大模型编程实践教程，32.7K+ stars，单周增长 5,497 星。从零开始讲解大语言模型的核心技术：Transformer 架构、预训练、微调、RLHF、RAG 等。每个章节都配有可运行的 Jupyter Notebook 代码，涵盖从基础数学推导到工业级应用的完整知识体系。是中文 AI 社区最受欢迎的大模型学习资源之一`,
...
createdAt: "2026-02-15T20:20:26Z",
    },
  {
      ...
      name: "Multica",
      category: "agent",
      description: "开源托管 Agent 平台，将 AI 编程 Agent 从一次性工具转变为真正的团队成员。支持任务分配、进度追踪、能力累积和历史回顾，每个 Agent 拥有独立的工作状态和成长记录。GitHub 17,519 Star，本周暴涨 7,831 星，2026 年增长最快的 Agent 管理平台，适合开发团队将 AI Agent 纳入日常协作流程",
