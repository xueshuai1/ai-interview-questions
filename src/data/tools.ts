...
export const tools: Tool[] = [
{
    ...
    },
  {
      ...
      category: "agent",
      description: "NousResearch 出品的可成长型 AI Agent 平台，101,073 stars，单周增长 42,612 stars（爆炸级），号称可成长型 AI，支持持续学习和能力累积，2026 年增长最快的开源 Agent 项目。通过经验积累和自我优化，Agent 能够在执行任务中不断提升效率和准确性",
