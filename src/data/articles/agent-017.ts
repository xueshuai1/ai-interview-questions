...
export const article: Article = {
  ...
  content: [
    ...
    },
    {
      ...
      body: `通用 Agent 的局限不是能力问题，而是**架构和工作流设计**的问题：`,
      list: [
...
class AgentTrader:
    ...
    },
    {
      ...
      body: `垂直 Agent 的崛起不仅仅是产品层面的变化，更在催生一个全新的**生态体系**：`,
      table: {
