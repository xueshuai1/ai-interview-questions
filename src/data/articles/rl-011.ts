...
export const article: Article = {
  ...
  content: [
    {
      title: "1. 什么是世界模型？",
      body: `世界模型（World Model）是 AI 系统对环境的**内部表征**——它让 Agent 能够在「脑海中」预测行动的后果，而不是每次都通过实际试错来学习。

这个概念最早由 Yann LeCun 提出：智能的核心能力之一就是**预测未来**。如果 AI 能够准确预测「如果我这样做，会发生什么」，它就能在不实际执行的情况下评估各种策略的优劣。
...
- 持续学习新的环境规律`,
    ...
    {
      title: "4. 四种规律领域",
      body: `Agentic World Modeling 论文还定义了世界模型需要处理的**四种规律领域**：
