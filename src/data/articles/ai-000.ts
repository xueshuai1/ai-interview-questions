...
> **2026 年的 LLM 已经不是「聊天机器人」了。** 它们是能干活的数字员工——能编程、能分析数据、能做研究、能帮你完成日常工作流中的重复任务。`,
    ...
    style D fill:#0d47a1,stroke:#42a5f5,color:#fff`
        },
        {
            ...
            body: `与其罗列一长串功能，不如从**你每天会碰到的场景**说起。
...
**真实案例：**
- **Rakuten（乐天）**：AI Agent 承担了 30% 的日常编码任务，开发者效率提升 40%
...
适合**想快速上手 AI 应用的开发者**。核心理念是「先学会用，再补基础」。
...
适合**想深入理解 AI 原理的学习者**。核心理念是「循序渐进，系统学习」。
...
AI 领域**每月都有重大突破**。2025 年初大家还在讨论 GPT-4，2025 年底 Claude Code 已经改变了软件开发范式，2026 年 AI Agent 生态爆发。**唯一不变的策略是：持续学习、持续实践。**
...
- **🚀 想快速上手** → 去看 [学习路线](/roadmap) 页面，选择速成路线
- **📚 想系统学习** → 去 [知识库](/knowledge) 页面，按分类浏览
- **🛠️ 想探索工具** → 去 [工具集](/tools) 页面，发现实用 AI 工具
...
祝你在 AI 学习之旅中收获满满。我们知识库见！🍪`,
            tip: "💡 小贴士：建议把这篇文章加入书签。每当你觉得迷茫或不知道下一步该学什么的时候，回来看看这张全景图，它会帮你重新找到方向。"
        }
    ]
};
