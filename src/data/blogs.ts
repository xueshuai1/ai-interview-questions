...
**关键词：** Agentic Coding、多 Agent 协调、人机协作、软件工程变革`,
    ...
    coverImage: "/images/blogs/agentic-coding-2026.jpg",
    readTime: 18,
  },
  {
    id: "blog-016",
...
**关键词：** 十万亿参数、Claude Mythos 5、Muse Spark、Gemini 3.1、AI 基础设施、MoE 架构、KV Cache 压缩`,
    ...
    coverImage: "/images/blogs/10t-parameter-era.jpg",
    readTime: 20,
  },
  {
    id: "blog-015",
...
**关键词：** Agent 评测、MiroEval、ViGoR-Bench、多模态、元认知、决策轨迹`,
    ...
    coverImage: "/images/blogs/agent-eval.jpg",
    readTime: 15,
  },
  {
    id: "blog-014",
...
*arXiv:2604.08525 — April 9, 2026*`,
    ...
    coverImage: "/images/blogs/ad-ai-chatbot.jpg",
    readTime: 18,
  },
  {
    id: "blog-013",
...
*研究模型：Claude Sonnet 4.5*`,
    ...
    coverImage: "/images/blogs/emotion-vectors.jpg",
    readTime: 15,
  },
  {
    id: "blog-011",
...
*发布日期：2026 年 4 月 12 日*`,
    ...
    coverImage: "/images/blogs/turboquant.jpg",
    readTime: 16,
  },
  {
    id: "blog-015",
...
否则，下一次"太强大而无法发布"的，可能就不是一个可以选择延迟的聊天模型了。`,
    ...
    coverImage: "/images/blogs/mythos-delay.jpg",
    readTime: 12,
  },
  {
    id: "blog-015",
...
**关键词：** 分布式训练、ZeRO、内存中心、GPU 优化、大语言模型`,
    ...
    coverImage: "/images/blogs/megatrain.jpg",
    readTime: 14,
  },
  {
    id: "blog-017",
