...
多模型切换"]
    ...
    class E s1
    class D s0
    classDef s0 fill:#1d4ed8,stroke:#1d4ed8,color:#fff
    classDef s1 fill:#047857,stroke:#047857,color:#fff
    classDef s2 fill:#1e3a5f,stroke:#2563eb,color:#fff`,
    },
    {
      title: "一、六大主流工具全景解析",
...
最激进的架构——AI 不仅是编程助手，而是**能自主操控计算机的代理**。它通过视觉感知理解界面，通过自然语言理解意图，通过工具调用来执行操作。优势是**能力边界最广**；劣势是**可控性较低**，需要人类监督。`,
    ...
    classDef s1 fill:#dc2626,stroke:#dc2626,color:#fff
    classDef s2 fill:#047857,stroke:#047857,color:#fff`,
    },
    {
