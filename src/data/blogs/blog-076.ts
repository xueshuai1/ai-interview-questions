...
- 自动获得版本更新和安全补丁`,
    ...
    subgraph "MCP Registry 出现前：碎片化的工具生态"
        ...
        T1 -.->|不兼容| T2
        T2 -.->|不兼容| T3
        style A1 fill:#991b1b
        style A2 fill:#991b1b
        style A3 fill:#991b1b
    end
...
**Phase 4（2026-2027）：生态平台化** — 第三方 MCP 市场出现，工具货币化`,
    ...
    style D1 fill:#92400e`,
    },
    {
      title: "七、MCP Registry 的安全与治理",
      body: `MCP Registry 的核心挑战不是技术，而是**信任**。当一个 AI Agent 可以自动发现并调用第三方工具时，安全问题变得至关重要。
