...
当前最热门的创新集中在 TTS 和 Voice Cloning 这两个输出环节。Voicebox、VoxCPM2 等项目的突破主要在这里。`,
    ...
    style F fill:#78350f,color:#f1f5f9
...
VoxCPM2 的核心技术是一个自回归 Transformer，直接预测连续的声学特征序列。与传统方案相比，它的主要优势在于端到端的简洁性和多语言的原生支持。`,
    ...
    style B1 fill:#064e3b,color:#f1f5f9
    style B3 fill:#78350f,color:#f1f5f9
    style A2 fill:#7f1d1d,color:#f1f5f9`,
    code: [
      {
        lang: "python",
...
if __name__ == "__main__":
  ...
  },
  {
    ...
    body: `如果说 Voicebox 和 VoxCPM2 代表了**语音合成**的技术进步，那么 **Omi**（BasedHardware）则展示了语音 AI 在**交互形态**上的创新。
